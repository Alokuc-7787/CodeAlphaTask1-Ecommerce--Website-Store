...
const navItems = ["Mobile Accessories", "Stationery", "Electronics", "More", "Deals", "About Us", "Contact"];
      ...
      <div className="nav-main-row">
        <div className="brand-block">
          ...
          <div>
            ...
            <p>Premium deals for mobile accessories, stationery, and electronics.</p>
          </div>
        </div>
